...
/* clasification.twig */
class __TwigTemplate_43e6d42171e1b98a796e67b52066e9e25bdcdbe0bf6b854d6827cc90ef2e0182 extends Twig_Template
{
    ...
    <body style=\"padding-top: 30px;padding-left: 30px;\">
          ...
          <div class=\"col-sm-8\">
                <h2>Users MYSQL</h2>
                    <table class=\"table table-bordered\">
                        <tr>
                            <th>Id</th><th>Team</th><th>Points</th>
                        </tr>
                        ";
        // line 35
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["clasification"]) ? $context["clasification"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["team"]) {
            ...
            echo "</td>
                                <td>";
            // line 38
            echo twig_escape_filter($this->env, $this->getAttribute($context["team"], "team", array()), "html", null, true);
            echo "</td>
                                <td>";
            // line 39
            echo twig_escape_filter($this->env, $this->getAttribute($context["team"], "points", array()), "html", null, true);
            echo "</td>
                            </tr>
                        ";
        }
